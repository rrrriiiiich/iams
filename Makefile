...
$(TARGET): ui_iams.h ui_second.h $(OBJECTS)  
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/iams.h src/second.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/iams.cpp src/second.cpp $(DISTDIR)/
	$(COPY_FILE) --parents src/iams.ui src/second.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_iams.cpp moc_second.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_iams.cpp moc_second.cpp
...
compiler_uic_make_all: ui_iams.h ui_second.h
compiler_uic_clean:
	-$(DEL_FILE) ui_iams.h ui_second.h
